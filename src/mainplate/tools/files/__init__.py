...
# may touch, and that decision is not this package's: a `Worktree` is files a conversation is about
# and is the only kind git can be asked about, a `Scratch` is what is nobody's repository. What each
...
__all__ = ["Files", "Scratch", "Worktree", "file_tools"]
