...
- [`docs/design/durability.md`](docs/design/durability.md): the stepwise capability, what one pass
  does, and what a session does when a provider says to come back later.
